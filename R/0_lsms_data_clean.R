...
# AB ~ c(1,110,111,112,113,114,115,116,138,101,102,103,104,105,106,107,108,109,172,173,180,181,182,191,190)
# C ~ c(3,140,141,142,143,144，162，163)
# D ~ c(4,131,134,135,136,137,139，145，146,164,165,166,167,168,169,171,174)
# E ~ c(5,117,118,119,122,123,124,121,120)
# F ~ c(6,130,132,133) 
# G ~ c(7,125) 
# H ~ c(8,127,129,150) 
# I ~ c(9,147) 
# J ~ c(11,148,149,151,152,153,154，155,156,158,159，170,160,161,128,175)
 


ug09.food.category.days = ug09.food %>%
  mutate( food_category = case_when(
    itmcd %in% c(1,110,111,112,113,114,115,116,138,101,102,103,104,105,106,107,108,109,172,173,180,181,182,191,190) ~  "AB",
    itmcd %in% c(3,140,141,142,143,144，162，163) ~  "C",
    itmcd %in% c(4,131,134,135,136,137,139，145，146,164,165,166,167,168,169,171,174) ~  "D",
    itmcd %in% c(5,117,118,119,122,123,124,121,120) ~  "E",
    itmcd %in% c(6,130,132,133) ~  "F",
    itmcd %in% c(7,125) ~  "G",
    itmcd %in% c(8,127,129,150) ~  "H",
    itmcd %in% c(9,147)  ~  "I",
    itmcd %in% c(11,148,149,151,152,153,154，155,156,158,159，170,160,161,128,175) ~ "J"
  )) %>%  
