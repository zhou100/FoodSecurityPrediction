...
**** carried out in year 2006-2007  obs.  5262 ***

*cd "/Users/yujunzhou/Box Sync/lsms/Ethiopia_2013/STATA"

cd "C:\Users\Administrator\Desktop\lsms\Ethiopia_2013/STATA"
...
use sect5b_hh_w2.dta,clear

*list hh_s5bq00  hh_s5bq02
*tab hh_s5bq00,nolabel
tab hh_s5bq02
...
sort household_id2
save ethiopia_2013.dta, replace
...
merge m:m household_id2 using ethiopia_2013
drop _merge
sort household_id2 
save ethiopia_2013, replace
...
*the CSI) is designed to capture quantity or sufficiency of consumption. 
	...
	***Merging the data
	keep household_id2 ea_id2 rCSI 
	merge m:m household_id2 using ethiopia_2013
	drop _merge
	save ethiopia_2013, replace
...
use "sect_cover_hh_w2",clear

keep household_id2 ea_id2 household_id2 ea_id2 rural saq03 saq04 pw saq01 hh_saq09 
...
use  sect_cover_hh_w2.dta,clear
...
gen survey_round ="2013/14 Ethiopia  socioeconomic survey wave two"
...
merge m:m household_id using ethiopia_2013
drop if _merge ==2
drop _merge
...
drop if FCS ==0 
drop if HDDS ==0
*save "/Users/yujunzhou/Box Sync/lsms/FCS_ethiopia_20113.dta",replace

save "C:\Users\Administrator\Desktop\lsms\cleaned_dataset\FCS_2013_Ethipopia.dta", replace
